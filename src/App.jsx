...
// ─── Theme Toggle (no emoji — uses text) ───
  ...
  return (
    <button
      ...
      style={{
        ...
        borderColor: isDark ? "rgba(139,127,212,0.4)" : "rgba(139,94,32,0.3)",
        background: isDark ? "rgba(139,127,212,0.15)" : "rgba(139,94,32,0.1)",
        color: isDark ? "#8B7FD4" : "#8B5E20",
        cursor: "pointer", fontSize: 11, fontWeight: 600,
        fontFamily: "'EB Garamond', Georgia, serif",
      }}
    >
      {/* Sun / Moon as SVG — no emoji */}
      {isDark ? (
...
// ─── Password show/hide — SVG eye instead of emoji ───
...
function AuthScreen({ isDark, setIsDark, onAuth }) {
  ...
  async function handleSubmit() {
    ...
    if (mode === "signup") {
      ...
      if (data.user) { setMessage("Account created! You can now log in."); setMode("login"); }
    } else {
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            ...
            <div>
              ...
              <div style={{ position: "relative" }}>
                ...
                <button onClick={() => setShowPass(s => !s)} style={{ position: "absolute", right: 12, top: "50%", transform: "translateY(-50%)", background: "none", border: "none", color: G.textMuted, cursor: "pointer", padding: 0, display: "flex", alignItems: "center" }}>
...
function ProfileScreen({ authUser, isDark, setIsDark, onSelect, onSignOut }) {
  ...
  async function createProfile() {
    ...
    setCreating(false); setNewUsername(""); setNewCurrency("₱"); setError("");
    setSaving(false);
    onSelect(newProfile);
  }
    ...
    <div style={{ minHeight: "100vh", width: "100vw", background: G.bg, fontFamily: "'EB Garamond', Georgia, serif", color: G.text, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: isMobile ? "24px 16px" : "40px 24px", boxSizing: "border-box", transition: "background 0.3s, color 0.3s" }}>
        ...
        <div style={{ position: "fixed", inset: 0, zIndex: 100, background: "rgba(0,0,0,0.6)", display: "flex", alignItems: "center", justifyContent: "center", padding: 20 }}>
          <div style={{ ...glassStyle({ padding: "28px 24px" }), maxWidth: 360, width: "100%", background: isDark ? "rgba(20,12,30,0.97)" : "rgba(245,240,232,0.97)" }}>
            ...
            <div style={{ display: "flex", gap: 10 }}>
              ...
              <button onClick={() => deleteProfile(confirmDelete)} style={{ flex: 1, padding: "11px", borderRadius: 11, background: `${G.red}18`, border: `1px solid ${G.red}40`, color: G.red, fontSize: 13, fontWeight: 700, cursor: "pointer", fontFamily: "inherit" }}>Delete</button>
            </div>
          </div>
        </div>
      )}
      ...
      <div style={{ width: "100%", maxWidth: isMobile ? "100%" : 480, position: "relative", zIndex: 1, marginTop: 40 }}>
        <div style={{ textAlign: "center", marginBottom: 32 }}>
          ...
          <div style={{ fontSize: 13, color: G.textMuted }}>Select or add a profile</div>
        </div>
        {loading ? (
              ...
              return (
                <div key={p.username} style={{ display: "flex", alignItems: "center", gap: 10, padding: "14px 18px", background: G.glass, backdropFilter: "blur(20px)", WebkitBackdropFilter: "blur(20px)", border: `1px solid ${G.glassBorder}`, borderRadius: 14 }}>
                  <button onClick={() => onSelect(p)} style={{ display: "flex", alignItems: "center", gap: 12, flex: 1, background: "transparent", border: "none", cursor: "pointer", color: G.text, fontFamily: "inherit", textAlign: "left", padding: 0 }}>
                    ...
                    <div style={{ fontSize: 16, color: G.textMuted, marginRight: 4 }}>›</div>
                  </button>
                  <button onClick={() => setConfirmDelete(p.username)} title="Delete profile" style={{ width: 32, height: 32, borderRadius: 9, background: `${G.red}12`, border: `1px solid ${G.red}30`, color: G.red, cursor: "pointer", fontSize: 16, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>×</button>
                </div>
              );
            })}
          </div>
        ...
        {!creating ? (
          <button onClick={() => setCreating(true)} style={{ width: "100%", padding: "13px", borderRadius: 14, background: G.accentSoft, border: `1px solid ${G.accent}40`, color: G.accent, fontSize: 14, fontWeight: 700, cursor: "pointer", fontFamily: "inherit", display: "flex", alignItems: "center", justifyContent: "center", gap: 8 }}>
            + Add Profile
          </button>
        ) : (
...
function BudgetApp({ authUser, activeProfile, onSwitchProfile, onSignOut, isDark, setIsDark }) {
  ...
  const tabLabels = { overview: "Overview", add: "Add", expenses: "History", goals: "Goals", wallet: "Wallet" };
      ...
      <div style={{ position: "relative", zIndex: 1, width: "100%", minHeight: "100vh", padding: isMobile ? "18px 16px 80px" : "24px 32px 90px", boxSizing: "border-box" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: isMobile ? 20 : 28, flexWrap: "wrap", gap: 10 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            <button onClick={onSwitchProfile} title="Switch Profile" style={{ display: "flex", alignItems: "center", gap: 9, padding: "7px 12px 7px 7px", background: G.glass, border: `1px solid ${G.glassBorder}`, borderRadius: 28, cursor: "pointer", color: G.text, fontFamily: "inherit" }}>
              ...
              <div style={{ textAlign: "left" }}>
                <div style={{ fontSize: 11, fontWeight: 600, lineHeight: 1.2 }}>{P}</div>
        ...
        {tab === "overview" && (
          <div style={grid2}>
            ...
            <div style={{ ...glassStyle({ padding: "16px 18px", display: "flex", alignItems: "center", justifyContent: "space-between" }) }}>
              <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                <div style={{ width: 38, height: 38, borderRadius: 11, background: G.accentSoft, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 17, color: G.accent }}>W</div>
                <div>
                ...
                {txForMonth(selectedMonth).sort((a,b) => new Date(b.date) - new Date(a.date)).slice(0, isMobile ? 5 : 8).map(t => {
                  ...
                  return (
                    <div key={t.id} style={{ display: "flex", alignItems: "center", gap: 10, padding: "9px 0", borderBottom: `1px solid ${G.glassBorder}` }}>
                      <div style={{ width: 32, height: 32, borderRadius: 9, background: `${color}18`, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 13, color, flexShrink: 0, fontWeight: 700 }}>{isInc ? "+" : "-"}</div>
            ...
            <div style={glassStyle({ padding: isMobile ? "18px" : "24px" })}>
              ...
              {expCat === "Other" && (
                <div style={{ marginTop: 12 }}>
                  <Field G={G} label="Specify expense">
              ...
              {txForMonth(selectedMonth).sort((a,b) => new Date(b.date) - new Date(a.date)).map(t => {
                ...
                return (
                  <div key={t.id} style={{ display: "flex", alignItems: "center", gap: 10, padding: "12px 0", borderBottom: `1px solid ${G.glassBorder}` }}>
                    <div style={{ width: 36, height: 36, borderRadius: 10, background: `${color}18`, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 15, color, flexShrink: 0, fontWeight: 700 }}>{isInc ? "+" : "-"}</div>
                    <div style={{ flex: 1, minWidth: 0 }}>
        ...
        {tab === "wallet" && (
          <div style={grid2}>
            <div style={{ ...glassStyle({ padding: isMobile ? "22px 18px" : "28px 26px", position: "relative", overflow: "hidden" }), gridColumn: isMobile ? "1" : "1 / -1" }}>
              ...
              <div style={{ fontSize: 12, color: G.textMuted }}>Cash on hand</div>
            </div>
            <div style={glassStyle({ padding: isMobile ? "18px" : "24px" })}>
              ...
              {[...wallet].sort((a,b) => new Date(b.date) - new Date(a.date)).map(w => {
                ...
                return (
                  <div key={w.id} style={{ display: "flex", alignItems: "center", gap: 10, padding: "10px 0", borderBottom: `1px solid ${G.glassBorder}` }}>
                    <div style={{ width: 34, height: 34, borderRadius: 9, background: isAdd ? `${G.green}18` : `${G.red}18`, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 15, color: isAdd ? G.green : G.red, flexShrink: 0, fontWeight: 700 }}>{isAdd ? "+" : "-"}</div>
                    <div style={{ flex: 1 }}>
        ...
        <div style={{ background: G.navBg, backdropFilter: "blur(24px)", WebkitBackdropFilter: "blur(24px)", border: `1px solid ${G.glassBorder}`, padding: isMobile ? "6px 8px" : "8px 12px", display: "flex", gap: isMobile ? 2 : 4, borderRadius: isMobile ? 22 : 28, width: "100%", boxShadow: `0 8px 40px ${isDark ? "rgba(0,0,0,0.6)" : "rgba(80,50,10,0.12)"}` }}>
          {tabs.map(t => (
            <button key={t} onClick={() => setTab(t)} style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", gap: 2, padding: isMobile ? "7px 4px" : "9px 8px", borderRadius: isMobile ? 14 : 18, border: "none", cursor: "pointer", background: tab === t ? G.accentSoft : "transparent", color: tab === t ? G.accent : G.textMuted, transition: "all 0.2s" }}>
              <span style={{ fontSize: isMobile ? 11 : 13, fontWeight: tab === t ? 700 : 500, fontFamily: "sans-serif" }}>{tabLabels[t]}</span>
            </button>
          ))}
        </div>
      </div>
...
function SectionTitle({ G, icon, iconBg, iconColor, title }) {
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 16 }}>
      <div style={{ width: 30, height: 30, borderRadius: 9, background: iconBg, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 16, fontWeight: 700, color: iconColor }}>{icon}</div>
